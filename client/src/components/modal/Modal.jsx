...
const Modal = ({ bg, tcolor, text, rounded, width, heigt, hover }) => {
  ...
  return (
    <div>
      <button
        className="bg-blue-500 w-[250px] rounded-3xl text-white h-[40px] active:bg-blue-600"
        ...
        <div className="flex flex-col h-[552px] rounded-md bg-white w-[792px]">
          ...
          <div className="flex gap-12">
            <div>
              ...
              {currentComponent === "Expense" ? <Exp /> : <Inc />}
            </div>
            <div>
